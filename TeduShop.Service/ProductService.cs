...
namespace TeduShop.Service
{
    public interface IProductService
    {
        ...
        IEnumerable<Product> GetListProductByCategoryId(int categoryId, int top);
    ...
    public class ProductService : IProductService
    {
        ...
        public IEnumerable<Product> GetListProductByCategoryId(int categoryId, int top)
        {

            var query = _productRepository.GetMulti(x => x.Status && x.CategoryID == categoryId).OrderByDescending(x => x.CreatedDate).Take(top);
            return query;
        }
    }
}